<aside class="sub-column sidebar<?php if (is_front_page()): ?> sidebar--index<?php endif; ?>">
    ...
    <div class="sidebar__item">
        <h3 class="sidebar__item-title">Release</h3>
        <iframe style="border: 0; width: 300px; height: 420px;" src="https://bandcamp.com/EmbeddedPlayer/album=1527863492/size=large/bgcol=ffffff/linkcol=0687f5/tracklist=false/transparent=true/" seamless><a href="http://lostmortal.bandcamp.com/album/journey-to-the-stars">Journey To The Stars by Lostmortal</a></iframe>
    </div>
    <div class="sidebar__item">
